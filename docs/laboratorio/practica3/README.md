...
```
   ...
   Configurar una Lista de control de acceso o *ACL* para permitir el tránsito de los mensajes de la Red Interna, e indicar en qué interfaz se llevará a cabo la traducción de las IP.
