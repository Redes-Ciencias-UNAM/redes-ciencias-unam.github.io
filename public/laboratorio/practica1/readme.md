...
8.  Regresar al sitio de Hurricane Electric, y configurar ahora el
...
9.  En el cuadro de diálogo ingresar el nombre de dominio registrado
...
10. Si la configuración fue correcta, aparecerá una pantalla similar a
...
11. A continuación se mostrarán dichos registros, con una configuración
...
12. Además, podemos utilizar el comando dig para verificar que la
    ...
    -   Consultas DNS al servidor autoritativo de Hurricane Electric.

        `dig SOA mi_dominio.tech @ns1.he.net`

        `dig NS mi_dominio.tech @ns1.he.net`

    -   Consultas DNS al servidor público de Google. Al hacer ésto se
        realiza una consulta DNS recursiva.

        `dig SOA mi_dominio.tech @8.8.8.8`

        `dig NS mi_dominio.tech @8.8.8.8`
