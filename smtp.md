...
<!-- <img alt="https://scs.senecac.on.ca/~john.selmys/subjects/ops335-091/howemailworks.png" src="https://scs.senecac.on.ca/~john.selmys/subjects/ops335-091/howemailworks.png" /> -->
<img alt="Elementos de una conexión SMTP" src="img/smtp.png" />
...
| **MDA**: Mail _Delivery_ Agent | IMAP(S),POP3(S),SMTPS,Summission	| Se encarga de **entregar**   el mensaje de correo electrónico | Dovecot, Courier, Cyrus, … |
...
<img alt="Elementos de una conexión directa al servidor SMTP de destino (MTA)" src="img/smtp-direct.png" />
...
<~  354  Go ahead 0123456789abcde.0 - gsmtp
 ~> Date: Tue, 20 Mar 2018 19:20:21 -0600
 ~> To: bob@example.net
 ~> From: alice@example.org
 ~> Subject: test Tue, 20 Mar 2018 19:20:21 -0600
 ~> X-Mailer: swaks v20130209.0 jetmore.org/john/code/swaks/
 ~> X-Test: TEST email
 ~> 
 ~> This is a test mailing
